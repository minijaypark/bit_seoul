...
#3. 컴파일, 훈련
from tensorflow.keras.models import load_model
model1 = load_model('./save/cifar10/model_cifar10_1.h5')
...
from tensorflow.keras.models import load_model
model2 = load_model('./model/cifar10_CheckPoint/cifar10-04-1.1151.hdf5')
...
# 3. 컴파일
model3.compile(loss='categorical_crossentropy', optimizer='adam', metrics=['acc'])
model3.load_weights('./save/cifar10/weight_cifar10_1.h5')
...
################### 1. load_model ########################
print("모델저장 loss : ", result1[0])
print("모델저장 accuracy : ", result1[1])

############## 2. load_model ModelCheckPoint #############
print("모델 체크포인트 loss : ", result2[0])
print("모델 체크포인트 accuracy : ", result2[1])

################ 3. load_weights ##################
print("가중치 loss : ", result3[0])
print("가중치 accuracy : ", result3[1])
