...
#3. 컴파일 훈련
modelpath = './model/{epoch:02d}-{val_loss:4f}.hdf5' #d는 두자리 정수 f는 소수 네자리까지
...
model.fit(x_train, y_train, epochs=30, batch_size=32, verbose=1, validation_split=0.2, callbacks=[early_Stopping, cp]) #원래 배치 사이즈의 디폴트는 32
